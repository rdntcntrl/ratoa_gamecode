...
typedef enum {
	...
	GTS_BLUE_DROPPED,
	GTS_NEUTRAL_DROPPED,
	GTS_ONE_PLAYER_LEFT_RED,
	GTS_ONE_PLAYER_LEFT_BLUE,
...
typedef enum {
	...
	SPECTATORGROUP_QUEUED_BLUE,
	SPECTATORGROUP_QUEUED_RED,
	SPECTATORGROUP_AFK
} spectatorGroup_t;
...
#define RAT_OFFHANDGRAPPLE	(1 << 28)
