...
vmCvar_t        g_voteBan;
vmCvar_t        g_voteKickProtectAdmins;
...
static cvarTable_t		gameCvarTable[] = {
	...
	// don't put the build date anywhere or the builds won't be reproducible
	...
	{ &g_motdfile, "g_motdfile", "motd.cfg", CVAR_ARCHIVE, 0, qfalse },
	{ &g_helpfile, "g_helpfile", "help.cfg", CVAR_ARCHIVE, 0, qfalse },
	{ &g_helpMotdWelcomePrefix, "g_helpMotdWelcomePrefix", "Welcome to ", CVAR_ARCHIVE, 0, qfalse },
...
// weapon config
	...
	{ &g_coinTime, "g_coinTime", "30", CVAR_ARCHIVE, 0, qfalse },
